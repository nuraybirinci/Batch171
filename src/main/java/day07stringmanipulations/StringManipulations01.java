...
public class StringManipulations01 {
    public static void main(String[] args) {
        ...
        //Ornek 4: "t" stringindeki kucuk harfler disindaki tum characterleri "<>" e ceviriniz
        String t4 =t.replace("[^a-z]","<>"); //?l? 13 y?s?nd?d?r!...

        //Ornek 5: "t" stringindeki tum harfler disindeki tum characterleri "+" ceviriniz
