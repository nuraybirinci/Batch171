...
/*
     ...
     */
        ...
        //int data type ını float data type ına ceviriniz
        int number = 43;
        System.out.println(number);
        float oneNumber= number;
        System.out.println(oneNumber);

        //double data type ini short data type ına ceviriniz
        double sayi =12.99;
        System.out.println(sayi);
        short tamsayi = (short) number;
        System.out.println(tamsayi); //12
